          ...
          <div>
            ...
            <div class="flex flex-col sm:flex-row gap-2">
              ...
              <button 
                ...
                class="w-full sm:w-auto px-4 py-2 bg-nandur-cream text-nandur-hover font-bold rounded-lg border border-nandur-cream/80 hover:bg-nandur-cream/80 transition-colors disabled:opacity-50 disabled:cursor-not-allowed whitespace-nowrap"
              >
