...
<template>
  <div class="min-h-screen bg-nandur-bg font-sans flex flex-col items-center pb-28 md:pb-36 relative">
    ...
    <div class="fixed bottom-6 md:bottom-10 left-0 right-0 z-40 flex justify-center pointer-events-none px-4">
      <div class="w-full max-w-3xl bg-nandur-surface/95 backdrop-blur-md shadow-[0_8px_30px_rgb(0,0,0,0.12)] border border-nandur-cream px-5 md:px-6 py-3 md:py-4 rounded-2xl flex justify-center gap-12 md:gap-20 pointer-events-auto items-center">
        <!-- Instagram -->
        ...
        <!-- WhatsApp -->
        <a href="https://wa.me/62895808920117" target="_blank" class="text-gray-400 hover:text-[#25D366] transition-colors hover:scale-110 transform duration-200" aria-label="WhatsApp">
